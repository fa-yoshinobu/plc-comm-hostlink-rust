...
- Library: Give every admitted UDP operation a fresh connected socket and distinct local endpoint while retaining at most one successful predecessor until its successor binds, preventing delayed, duplicate, or foreign-source datagrams from completing a later operation.
